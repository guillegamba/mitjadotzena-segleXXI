      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 group relative overflow-hidden hover:-translate-y-2">
              {/* Gradient Layer */}
              <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradientClass} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
